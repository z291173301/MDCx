...
![Crawlers](https://img.shields.io/badge/Sites-52-brightgreen.svg)
...
MDCx 是一个桌面工具，自动从 52 个网站抓取视频文件的元数据（标题、演员、封面、简介等），生成标准的 .nfo 文件和整理好的文件夹，给 Emby、Jellyfin、Kodi 这类媒体服务器直接用。
...
- **52 个网站爬虫** — 有码、无码、FC2、国产、欧美全覆盖，部分站点免 CF 直连
