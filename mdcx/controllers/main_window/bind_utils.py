...
def get_checkbox[T](component: QCheckBox | QRadioButton, on_value: T = True, off_value: T = False) -> T:  # type: ignore[assignment]
    """
    根据二值输入组件返回开启或关闭的配置值
...
def get_radio_buttons[T](*radio_mappings: tuple[QRadioButton, T], default: T = "") -> T:  # type: ignore[assignment]
    """
    根据一组单选按钮的选中状态生成配置值
